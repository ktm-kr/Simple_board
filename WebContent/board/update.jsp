...
<h1 class="mt-5"><b>업로드 파일 수정하기</b></h1>
	
	<form method="post" action="${pageContext.request.contextPath}/update" >
		<div class="upload2 border border-secondary rounded mt-5 mb-5">
			<input type="hidden" class="form-control" value="${num}" name="num"><br>
			...
			<div class="btn1 mt-5">
				<button type="submit" class="btn btn-outline-secondary" style="text-align: right;" >수정하기</button>	
